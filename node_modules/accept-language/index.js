    ...
    languageTags = languageTags
      ...
      .map(function(languageTag) {
        ...
        if(languageTag.region) {
          ...
          // So if the defined language tags are ['es-419', 'es-US']
          ...
          if(this_.languageTags_[language].regions.length > 0) {
            return {
              value: this_.languageTags_[language].values[0],
              language: language,
              region: this_.languageTags_[language].regions[0],
              quality: languageTag.quality
            };
          }
        }
